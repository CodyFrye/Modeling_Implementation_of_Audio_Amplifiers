...
%This script does not take into account the Miller effect or parasitic
%capacitances since Leach's model is used opposed to Norman Koren's model
...
%calculate the grid current as a function of Vpk
Ig_Vgk_1 = Ig_fcn_Vgk();
...
%plot the grid current for Ig as function of Vgk
figure(3)
plot(Ig_Vgk_1)
title('Current (Ig) as a function of Vgk')
xlim([0 2])
